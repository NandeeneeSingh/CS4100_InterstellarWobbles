...
plt.legend()
plt.tight_layout()
plt.savefig('data/model/sb2_example_rv_curve.png', dpi=200)
print(f"Saved example RV curve to data/model/sb2_example_rv_curve.png")
...
df.to_csv('data/model/sb2_forward_model_results.csv', index=False)
